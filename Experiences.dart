  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 150, 0, 132),
      ),
      body: Container(
  ...
  Widget _buildExperienceTile({
    ...
    return ListTile(
      ...
      leading: Container(
        ...
        decoration: BoxDecoration(
          color: Color.fromARGB(255, 244, 250, 78), // Change the color to teal
      ...
      subtitle: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(role, style: TextStyle(fontSize: 18, color: Color.fromARGB(179, 0, 0, 0))),
          Text(
            years,
            style: TextStyle(fontSize: 16, color: Color.fromARGB(255, 199, 9, 9)),
          ),
          SizedBox(height: 8), // Add spacing between role/years and about
          Text(
            about,
            style: TextStyle(fontSize: 16, color: Color.fromARGB(255, 66, 11, 96)),
          ),
        ],
      ),
    );
