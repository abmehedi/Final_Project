...
class _CalculatorScreenState extends State<CalculatorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 234, 227, 11),
      body: Column(
        children: [
          Expanded(
            flex: 2,
            child: Container(
              ...
              child: Text(
                ...
                style: TextStyle(
                  ...
                  color: const Color.fromARGB(255, 190, 6, 6),
                ),
              ),
            ),
          ),
  ...
  Widget _buildButton(String buttonText) {
    return Container(
      ...
      child: ElevatedButton(
        ...
        style: ButtonStyle(
          backgroundColor: MaterialStateProperty.all(Color.fromARGB(135, 232, 195, 7)),
