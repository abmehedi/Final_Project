...
class _QuizScreenState extends State<QuizScreen> {
    ...
    Future.delayed(Duration(seconds: 1), () {
      setState(() {
        if (questionIndex < questions.length - 1) {
          questionIndex++;
          isAnswered = false;
          remainingMinutes = quizTimeInSeconds; // Reset timer for the next question
        } else {
    ...
    Future.delayed(Duration(seconds: 1), () {
      setState(() {
        if (remainingMinutes > 0) {
          ...
          remainingMinutes = quizTimeInSeconds; // Reset the timer for the next quiz
          shuffleQuestionsAndOptions(); // Shuffle questions and options for the next quiz
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        color: Color.fromARGB(255, 245, 253, 1), // Change the background color to black
        child: Column(
          children: [
            SizedBox(height: 30),
            Text(
            ...
            Padding(
              ...
              child: Text(
                ...
                style: TextStyle(
                    fontSize: 25,
                    fontWeight: FontWeight.bold,
                    color: Color.fromARGB(255, 212, 12, 199)
                ),
              ),
            ),
            Padding(
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 20,
                                color: const Color.fromARGB(153, 0, 0, 0)// Increase the font size
                            ),
                          ),
                          SizedBox(width: 10),
                          Text(
